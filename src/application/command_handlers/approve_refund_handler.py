...
from src.application.dto.refund_dto import ApproveRefundResponseDTO
    ...
    def handle(
        ...
        try:
            ...
            if event.organizer_id != command.organizer_id:
                raise PermissionError("Only the event organizer can approve this refund.")
            ...
            return ApproveRefundResponseDTO(
                refund_id=refund.id,
